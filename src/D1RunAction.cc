...
{ 
  ...
  analysisManager->CreateH1("3","trackL in Shape1", 100, 0., 100*cm, "cm" );
  analysisManager->CreateH1("4","trackL in the light guide", 100, 0., 50*cm, "cm");  
 analysisManager->CreateH1("3","Nofsecondary  in Shape1", 100, 0., 100*cm, "cm" );
  analysisManager->CreateH1("4","NoSecondary in the light guide", 100, 0., 50*cm, "cm");  
...
void D1RunAction::BeginOfRunAction(const G4Run* /*Run*/)
{
