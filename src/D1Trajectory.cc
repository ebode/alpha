...
D1Trajectory::D1Trajectory()
  :G4Trajectory(),fShape1(false),fDrawit(false),fForceNoDraw(false),fForceDraw(false)
{
...
D1Trajectory::D1Trajectory(const G4Track* aTrack)
  :G4Trajectory(aTrack),fShape1(false),fDrawit(false)
{
...
D1Trajectory::D1Trajectory(D1Trajectory &right)
  :G4Trajectory(right),fShape1(right.fShape1),fDrawit(right.fDrawit)
{
